...
import { deleteEntity, getEntities, reset } from './subject.reducer';
...
export const Subject = () => {
  ...
  const links = useAppSelector(state => state.subject.links);
  ...
  const confirmDelete = () => {
    if (subjectToDeleteId) {
      dispatch(deleteEntity(subjectToDeleteId));
  ...
  return (
    <div>
      ...
      <div className="table-responsive">
        <InfiniteScroll
          dataLength={subjectList ? subjectList.length : 0}
          next={handleLoadMore}
        ...
        >
          {subjectList && subjectList.length > 0 ? (
            ...
            !loading && <div className="alert alert-warning my-4">No Subjects found</div>
          )}
        </InfiniteScroll>
        <Modal isOpen={loadModal} toggle={handleClose}>
          ...
          <ModalBody id="educationclickApp.subject.delete.question">Are you sure you want to delete subject?</ModalBody>
          <ModalFooter>
