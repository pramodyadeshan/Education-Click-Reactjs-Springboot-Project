...
class TeacherResourceIT {
    ...
    public static Teacher createEntity(EntityManager em) {
        Teacher teacher = new Teacher().name(DEFAULT_NAME).subject(DEFAULT_SUBJECT).email(DEFAULT_EMAIL).feePerHour(DEFAULT_FEE_PER_HOUR);
        return teacher;
    }
    ...
    public static Teacher createUpdatedEntity(EntityManager em) {
        Teacher teacher = new Teacher().name(UPDATED_NAME).subject(UPDATED_SUBJECT).email(UPDATED_EMAIL).feePerHour(UPDATED_FEE_PER_HOUR);
        return teacher;
    }
    ...
    void putExistingTeacher() throws Exception {
        ...
        updatedTeacher.name(UPDATED_NAME).subject(UPDATED_SUBJECT).email(UPDATED_EMAIL).feePerHour(UPDATED_FEE_PER_HOUR);
    ...
    void partialUpdateTeacherWithPatch() throws Exception {
        ...
        partialUpdatedTeacher.name(UPDATED_NAME).subject(UPDATED_SUBJECT).feePerHour(UPDATED_FEE_PER_HOUR);
    ...
    void fullUpdateTeacherWithPatch() throws Exception {
        ...
        partialUpdatedTeacher.name(UPDATED_NAME).subject(UPDATED_SUBJECT).email(UPDATED_EMAIL).feePerHour(UPDATED_FEE_PER_HOUR);
